...
class Adan(Optimizer):
    ...
    def __init__(self,
                 ...
                 eps=1e-8,
                 weight_decay=0.0,
                 # weight_decay=0.02,  # zxy
                 max_grad_norm=0.0,
                 no_prox=False,
                 # foreach: bool = True,
                 foreach: bool = False,  # zxy
                 fused: bool = False):
        if not 0.0 <= max_grad_norm:
            raise ValueError('Invalid Max grad norm: {}'.format(max_grad_norm))
        # print('lr:', lr)
        if not 0.0 <= lr:
        # if not 0.0 <= lr or 0.0 <= lr:
        ...
        # print('params', params)
        # print('super:', super())  # <super: <class 'Adan'>, <Adan object>>
        # print('super.__init__:', super(Adan, self).__init__(params, defaults))  # super.__init__: None
        # print('super.__init__:', super().__init__(params, defaults))  # super.__init__: None
        super().__init__(params, defaults)  # from torch.optim.optimizer import Optimizer
        # super(Adan, self).__init__(params, defaults)  # zxy
