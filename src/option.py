...
# parser.add_argument('--data_test', type=str, default='Urban100',
...
parser.add_argument('--patch_size', type=int, default=128,  # train para
# parser.add_argument('--patch_size', type=int, default=126,  # x3
...
parser.add_argument('--model', default='tsrnet',
                    help='model name')
...
parser.add_argument('--optimizer', default='ADAN',
                    choices=('SGD', 'ADAM', 'RMSprop', 'ADAN'),  # new ADAN
...
parser.add_argument('--test_demo', action='store_true',
                    help='test my own pic')
